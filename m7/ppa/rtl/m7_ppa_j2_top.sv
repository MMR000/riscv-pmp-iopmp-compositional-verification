// J2: Ibex PMP + DMA + IOPMP + arbiter (RST-A security_config defaults).
module m7_ppa_j2_top (
    input  logic clk,
    input  logic rst_n,
    ...
    m7_ppa_top #(.PMPEnable(1'b1), .INCLUDE_COMPOSITION(1'b1), .INCLUDE_DOMAIN_RESET(1'b0)) u (.*);
endmodule
