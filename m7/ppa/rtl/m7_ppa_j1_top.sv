// J1: real Ibex + architectural PMP (PMPEnable=1), no DMA/IOPMP.
module m7_ppa_j1_top (
    input  logic clk,
    input  logic rst_n,
    ...
    m7_ppa_top #(.PMPEnable(1'b1), .INCLUDE_COMPOSITION(1'b0), .INCLUDE_DOMAIN_RESET(1'b0)) u (.*);
endmodule
