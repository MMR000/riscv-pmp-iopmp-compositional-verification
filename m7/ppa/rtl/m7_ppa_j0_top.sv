// J0: real Ibex baseline, PMPEnable=0, no DMA/IOPMP composition.
module m7_ppa_j0_top (
    input  logic clk,
    input  logic rst_n,
    ...
    m7_ppa_top #(.PMPEnable(1'b0), .INCLUDE_COMPOSITION(1'b0), .INCLUDE_DOMAIN_RESET(1'b0)) u (.*);
endmodule
