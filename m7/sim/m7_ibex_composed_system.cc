...
#include "m7_ibex_composed_system.h"
#include "verilator_sim_ctrl.h"

M7ComposedSystem::M7ComposedSystem()
    : _ram("TOP.m7_ibex_composed_top.u_ram.u_ram", kRAM_SizeBytes / 4, 4) {}

int M7ComposedSystem::Main(int argc, char **argv) {
  ...
  std::cout << "M7 Ibex composed simulation" << std::endl;
